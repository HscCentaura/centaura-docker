...
function nuntius_scripts() {
	...
	wp_enqueue_script( 'nuntius-functions-js', get_template_directory_uri().'/js/functions.js', array( 'jquery'), '201101207' );
}
...
<div id="<?php echo $nav_id; ?>">
  <h1 class="assistive-text section-heading">
    <?php _e( 'Post navigation', 'nuntius' ); ?>
  </h1>
  ...
  <div class="nav-previous">
    <?php next_posts_link( __( '<span class="meta-nav">&larr;</span> Older posts', 'nuntius' ) ); ?>
  </div>
  <?php endif; ?>
  <?php if ( get_previous_posts_link() ) : ?>
  <div class="nav-next">
    <?php previous_posts_link( __( 'Newer posts <span class="meta-nav">&rarr;</span>', 'nuntius' ) ); ?>
  </div>
  <?php endif; ?>
  <?php endif; ?>
</div>
...
function nuntius_tag_list() {
	...
	if ( '' != $tag_list ) {
		$utility_text = "<span class='entry-permalink'>&nbsp;</span>";/*__( '<span class="tag-links">Tags: %1$s</a></span> <span class="entry-permalink"><a href="%2$s" title="Permalink to %3$s" rel="bookmark">Permalink</a></span>', 'nuntius' ); */	} else {
		$utility_text = "<span class='entry-permalink'>&nbsp;</span>";/*__( '<span class="entry-permalink"><a href="%2$s" title="Permalink to %3$s" rel="bookmark">Permalink</a></span>', 'nuntius' );*/
	}
	printf(
		$utility_text,
		$tag_list,
...
<li <?php comment_class(); ?> id="li-comment-<?php comment_ID(); ?>">
  <div id="comment-<?php comment_ID(); ?>" class="comment-wrap">
    <div class="comment-head comment-author vcard"> <?php echo get_avatar( $comment, 48 ); ?> <span class="comment-meta commentmetadata"> <cite class="fn">
      <?php comment_author_link(); ?>
      </cite> <a href="<?php echo esc_url( get_comment_link( $comment->comment_ID ) ); ?>" class="comment-date">
      <?php
      ...
      <?php comment_reply_link( array_merge( $args, array( 'depth' => $depth, 'max_depth' => $args['max_depth'], 'reply_text' => __( 'Reply', 'nuntius' ) ) ) ); ?>
      </span>
      <?php endif; ?>
      </span><!-- .comment-meta .commentmetadata --> 
    </div>
    <!-- .comment-head .comment-author .vcard -->
    
    <div class="comment-content comment-text">
      <?php if ( $comment->comment_approved == '0' ) : ?>
      <em>
      <?php _e( 'Your comment is awaiting moderation.', 'nuntius' ); ?>
      </em> <br />
      <?php endif; ?>
      <?php comment_text(); ?>
    </div>
...
<ul>
  <li>
    <?php _e( 'Browsing: <span class="sep">&raquo;</span> ', 'nuntius' ); ?>
  </li>
  <?php
		/* Add the Home link */
	?>
  ...
  <li>
    <?php _e( '<span class="sep">&raquo;</span>' , 'nuntius' );
					...
					?>
    <?php echo single_cat_title( '', false ); ?> </li>
  <?php elseif ( is_archive() && ! is_category() ) : ?>
  <li>
    <?php _e( '<span class="sep">&raquo;</span> Archives' , 'nuntius' ); ?>
    </a></li>
  <?php elseif ( is_search() ) : ?>
  <li>
    <?php _e( '<span class="sep">&raquo;</span> Search Results' , 'nuntius' ); ?>
    </a></li>
  <?php elseif ( is_404() ): ?>
  <li>
    <?php _e( '<span class="sep">&raquo;</span> 404 Not Found' , 'nuntius'); ?>
    </a></li>
  ...
  <li>
    <?php _e( '<span class="sep">&raquo;</span>', 'nuntius' ); ?>
    <a href="<?php echo esc_url( get_permalink( $ancestor ) ); ?>"><?php echo strip_tags( apply_filters( 'single_post_title', get_the_title( $ancestor ) ) ); ?></a> </li>
  <?php else : ?>
  <li>
    <?php _e( '<span class="sep">&raquo;</span>', 'nuntius' ); ?>
    <?php echo strip_tags( apply_filters( 'single_post_title', get_the_title( $ancestor ) ) ); ?> </li>
  <?php endif;
					endforeach;
				endif;
			endif;
